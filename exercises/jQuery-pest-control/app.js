...
$("#cheepButton, #shabangButton, #bombButton, #goombaButton").click(function () {
    audio.play();
});
...
$("#nightLight").click(function () {
        ...
        $("#nightLight").text("Switch back");
        $(".totalPrice").toggleClass("nightLight");
        $("button").toggleClass("nightLight");
        $("strong").toggleClass("nightLight");
    });
